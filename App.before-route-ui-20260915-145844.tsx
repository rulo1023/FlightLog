      ...
      <ScrollView contentContainerStyle={styles.editContent} keyboardShouldPersistTaps="handled">
        ...
        {details && <>
          <View style={styles.card}>
            ...
            {(draft.actualDepartureAt || draft.actualArrivalAt) && (
              <View style={styles.lookupMessage}>
                <Text style={styles.lookupText}>
                  Salida real: {draft.actualDepartureAt
                    ? new Date(draft.actualDepartureAt)
                        .toLocaleTimeString(
                          'es-ES',
                          {
                            hour: '2-digit',
                    ...
                    : '--:--'}
                  {'   '}Llegada real: {draft.actualArrivalAt
                    ? new Date(draft.actualArrivalAt)
                        .toLocaleTimeString(
                          'es-ES',
                          {
                            hour: '2-digit',
